...
@pytest.mark.parametrize('string, result',
                         [('hello', 'Hello'), ('hi, dude', 'Hi, dude'), ('2024', '2024'), ('august 2024', 'August 2024')])
...
@pytest.mark.parametrize('string, result',
                         [('', ''), ('0hi, dude', '0hi, dude'), ('   ', '   '), ('2024 august', '2024 august')])
...
@pytest.mark.parametrize('string, result',
                         [('   hello', 'hello'), ('   hi, dude   ', 'hi, dude   '), ('   august 2024', 'august 2024')])
...
@pytest.mark.parametrize('string, delimiter, result',
                         [('h,e,l,l,o', None, ['h','e', 'l', 'l', 'o']), ('1and2', 'and', ['1','2'])])
...
@pytest.mark.parametrize('string, symbol, result',
                         [('student', 'n', True), ('student', 'y', False), ('2024', '0', True)])
...
@pytest.mark.parametrize('string, symbol, result',
                         [('annigilation', 'n', 'aigilatio'), ('good morning', 'good ', 'morning'), ('2024', '4', '202')])
...
@pytest.mark.parametrize('string, symbol, result',
                         [('annigilation', 'm', 'annigilation'), ('annigilation', '', 'annigilation'), ('', '', ''), ('', '4', '')])
...
@pytest.mark.parametrize('string, symbol, result',
                         [('annigilation', 'a', True), ('good day', 'g', True), ('2024', '2', True)])
...
@pytest.mark.parametrize('string, symbol, result',
                         [('morning', 'n', False), ('morning', ' ', False), ('', 'm', False)])
...
@pytest.mark.parametrize('string, symbol, result',
                         [('annigilation', 'n', True), ('morning', 'g', True), ('good day', 'y', True), ('2024', '4', True)])
...
@pytest.mark.parametrize('string, symbol, result',
                         [('annigilation', 'a', False), ('morning', ' ', False), (' ', 'a', False), ('2024', '2', False)])
...
@pytest.mark.parametrize('string, result',
                         [('annigilation', False), (' morning', False), ('2024 ', False)])
...
@pytest.mark.parametrize('lst, joiner, result',
                         [([8, 9, 10], '', '8, 9, 10'), (['help', 'me'], '_', 'help_me'), (['A', 'S', 'A', 'P'], '', 'ASAP')])
